    ...
    : IdentityDbContext<IdentityUser>(options), IDataProtectionKeyContext
{
    ...
    // This allows all deployed instances to use the same key ring.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Resident>(entity =>
        {
            ...
            entity.HasIndex(resident => resident.IdentityUserId)
                .IsUnique()
        ...
        modelBuilder.Entity<WaterConnection>(entity =>
        {
            ...
            entity.HasKey(connection => connection.WaterConnectionId)
                .HasName("PK_WaterConnections");

            entity.Property(connection => connection.WaterConnectionId)
                .ValueGeneratedOnAdd();

            entity.Property(connection => connection.ConnectionNumber)
                .HasMaxLength(40)
                .IsRequired();

            entity.Property(connection => connection.ConnectionType)
                .HasConversion<string>()
                .HasMaxLength(20)
                .IsRequired();

            entity.Property(connection => connection.MeterNumber)
                .HasMaxLength(40)
                .IsRequired();
            ...
            entity.HasIndex(connection => connection.ConnectionNumber)
                .IsUnique();

            entity.HasOne<Resident>()
                .WithMany()
                .HasForeignKey(connection => connection.ResidentId)
        ...
        modelBuilder.Entity<MeterReading>(entity =>
        {
            ...
            entity.HasKey(reading => reading.MeterReadingId)
                .HasName("PK_MeterReadings");

            entity.Property(reading => reading.MeterReadingId)
                .ValueGeneratedOnAdd();
            ...
            entity.HasIndex(reading => new
                {
                    reading.WaterConnectionId,
                    reading.ReadingDate
                })
                .IsUnique();

            entity.HasOne<WaterConnection>()
                .WithMany()
                .HasForeignKey(reading => reading.WaterConnectionId)
        ...
        modelBuilder.Entity<Bill>(entity =>
        {
            ...
            entity.Property(bill => bill.BillId)
                .ValueGeneratedOnAdd();

            entity.Property(bill => bill.UnitsConsumed)
                .HasColumnType("int");

            entity.Property(bill => bill.RatePerUnit)
                .HasColumnType("decimal(18,2)");
            ...
            entity.HasIndex(bill => new
                {
                    bill.WaterConnectionId,
                    bill.BillDate
                })
                .IsUnique();
            ...
            entity.HasOne<WaterConnection>()
                .WithMany()
                .HasForeignKey(bill => bill.WaterConnectionId)
                .OnDelete(DeleteBehavior.Cascade);

            entity.HasOne<MeterReading>()
                .WithMany()
                .HasForeignKey(bill => bill.MeterReadingId)
                .OnDelete(DeleteBehavior.Restrict);
        });
        ...
        modelBuilder.Entity<ServiceRequest>(entity =>
        {
            ...
            entity.Property(request => request.ServiceRequestId)
                .ValueGeneratedOnAdd();
